package com.patternfly.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.patternfly";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/SpringMVC-model"),
        mapper("/SpringMVC-dao"),
        mapperxml("/SpringMVC-web"),
        service("/SpringMVC-service"),
        web("/SpringMVC-web"),
        ;
